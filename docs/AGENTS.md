...
- Keep architecture documentation focused on workspace, adapter boundaries, runtime separation, worker/session boundaries, native ABI, service entry points, and CLI validation.
